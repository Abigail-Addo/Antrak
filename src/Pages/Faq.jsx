        ...
        <div className="wrapper container">
          <div className="py-5">
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  services, including freight forwarding, customs clearance,
                  documentation management, packing and insurance, and global
                  logistics solutions. We can handle car parts, merchandise,
                  vehicles, and even entire container loads.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  destination in the world. Contact us for details on specific
                  countries.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  We use high-quality packing materials specifically designed to
                  protect your cargo during transit. We can tailor the packing
                  solution to the specific needs of your shipment.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  We offer a variety of delivery options depending on your needs
                  and budget. This may include port-to-port, door-to-door, or
                  other options.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  The transit time for your shipment will depend on the origin,
                  destination, and chosen shipping method. We will provide you
                  with an estimated delivery timeframe during the quoting
                  process.
                </Typography>
              </AccordionDetails>
            </Accordion>

            <div className="py-3 px-3 w-100 border fw-bold">Contact Us</div>
            <Accordion
            ...
            >
              ...
              <AccordionDetails>
                <Typography>
                  You can contact us by filling out our online contact form,
                  calling us at{" "}
